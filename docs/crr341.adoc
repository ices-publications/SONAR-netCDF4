...
The netCDF4 group name is */Sonar* and contains three subgroups, all of which have an obligation of Optional (it is expected that a useful SONAR-netCDF4 file will have at least one of these subgroups, but is it not required).
...
|{revnumber}|2.0 | April 2022|Significant additions to support additional sonar types. Beam_group is now optional.
