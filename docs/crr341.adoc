...
This group contains the Single Target detection from split-aperture beams positioned with their range and split-aperture arrival angles. Target Strength (TS) is calculated using conversion equations detailed in <<Conversion equations>>.
Algorithm for single target detection and parameters are detailed in citenp:[Soule1997].
The netCDF4 group name is SingleTarget and is a subgroup of /Sonar/Beam_group.
