...
This group contains the calculated SV, for a single ping or 
...
include::tableVolumeBackscater_sub_group.adoc[]
...
include::tableAveragedVolumeBackscater_sub_group.adoc[]
...
==== Proposed SimradWBT vendor specific additions

This group contains optional transducer and Simrad WBT information for processing.

.Description of the SimradWBT group in the Vendor group.
[[sonarVendor_specific_SimradWBT_Table]]
include::tableVendor_specific_SimradWBT_group.adoc[]
...
Beam:: Added variable for the transmit pulse slope.
...
Vendor_specific_SimradWBT:: A new group, Vendor_specific_SimradWBT, has been added to provide transducer and transceiver information for processing.
