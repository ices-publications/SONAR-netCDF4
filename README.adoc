...
A preview of the latest working draft is available https://gitcdn.link/repo/ices-publications/SONAR-netCDF4/master/Formatted_docs/crr341.html[here] (note that this can be up to 2 hours out-of-date).
