...
A preview of the latest working draft is available https://htmlpreview.github.io/?https://github.com/ices-publications/SONAR-netCDF4/blob/master/Formatted_docs/crr341.html[here] (note that it takes a few minutes for new changes to appear).
